...
pub mod non_leaf_tournament {
    ...
    pub static NONLEAFTOURNAMENT_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware> NonLeafTournament<M> {
        ...
        pub fn win_inner_match(
            ...
            self.0
                .method_hash(
                    [180, 1, 134, 92],
                    (child_tournament, left_node, right_node),
                )
                .expect("method not found (this should never happen)")
        }
    ...
    #[ethevent(name = "newInnerTournament", abi = "newInnerTournament(bytes32,address)")]
    ...
    impl ::core::fmt::Display for NonLeafTournamentEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::NewInnerTournamentFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
            }
        }
    ...
    impl ::ethers::core::abi::AbiDecode for NonLeafTournamentCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SealInnerMatchAndCreateInnerTournamentCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <UpdateTournamentDelayCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::UpdateTournamentDelay(decoded));
            }
            if let Ok(decoded)
                = <WinInnerMatchCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::convert::From<TournamentWinnerCall> for NonLeafTournamentCalls {
