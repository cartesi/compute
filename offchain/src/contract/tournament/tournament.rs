...
pub mod tournament {
    ...
    pub static TOURNAMENT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct Tournament<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for Tournament<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for Tournament<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for Tournament<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for Tournament<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Tournament)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Tournament<M> {
    ...
    impl ::core::fmt::Display for TournamentEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::ethers::core::abi::AbiDecode for TournamentCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for TournamentCalls {
    ...
    impl ::core::fmt::Display for TournamentCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AdvanceMatchCall> for TournamentCalls {
        fn from(value: AdvanceMatchCall) -> Self {
            Self::AdvanceMatch(value)
        }
    }
    impl ::core::convert::From<CanWinMatchByTimeoutCall> for TournamentCalls {
        fn from(value: CanWinMatchByTimeoutCall) -> Self {
            Self::CanWinMatchByTimeout(value)
        }
    }
    impl ::core::convert::From<GetCommitmentCall> for TournamentCalls {
        fn from(value: GetCommitmentCall) -> Self {
            Self::GetCommitment(value)
        }
    }
    impl ::core::convert::From<GetMatchCall> for TournamentCalls {
        fn from(value: GetMatchCall) -> Self {
            Self::GetMatch(value)
        }
    }
    impl ::core::convert::From<GetMatchCycleCall> for TournamentCalls {
        fn from(value: GetMatchCycleCall) -> Self {
            Self::GetMatchCycle(value)
        }
    }
    impl ::core::convert::From<JoinTournamentCall> for TournamentCalls {
        fn from(value: JoinTournamentCall) -> Self {
            Self::JoinTournament(value)
        }
    }
    impl ::core::convert::From<MaximumEnforceableDelayCall> for TournamentCalls {
        fn from(value: MaximumEnforceableDelayCall) -> Self {
            Self::MaximumEnforceableDelay(value)
        }
    }
    impl ::core::convert::From<TournamentLevelConstantsCall> for TournamentCalls {
        fn from(value: TournamentLevelConstantsCall) -> Self {
            Self::TournamentLevelConstants(value)
        }
    }
    impl ::core::convert::From<TournamentWinnerCall> for TournamentCalls {
        fn from(value: TournamentWinnerCall) -> Self {
            Self::TournamentWinner(value)
        }
    }
    impl ::core::convert::From<WinMatchByTimeoutCall> for TournamentCalls {
